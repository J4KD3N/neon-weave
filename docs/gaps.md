...
- **Three AI archetypes** (rusher, ranged, stealther) that approach by walking distance (D-066). Summoner and controller wait on their mechanics (S16). Hidden combatants are drawn faint for both sides; no true fog or detection roll yet.
